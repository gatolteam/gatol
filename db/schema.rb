...
ActiveRecord::Schema.define(version: 20151104004940) do
  ...
  add_index "games", ["game_template_id"], name: "index_games_on_game_template_id"
  add_index "games", ["question_set_id"], name: "index_games_on_question_set_id"
  add_index "games", ["trainer_id"], name: "index_games_on_trainer_id"
  ...
  add_index "training_history", ["game_id"], name: "index_training_history_on_game_id"
  add_index "training_history", ["student_id"], name: "index_training_history_on_student_id"
